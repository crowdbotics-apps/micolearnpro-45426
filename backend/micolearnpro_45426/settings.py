"""
Django settings for micolearnpro_45426 project.
...
ROOT_URLCONF = 'micolearnpro_45426.urls'
...
WSGI_APPLICATION = 'micolearnpro_45426.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "micolearnpro_45426 API",
    "DESCRIPTION": "API documentation for micolearnpro_45426 App",
    "VERSION": "v1",
}
